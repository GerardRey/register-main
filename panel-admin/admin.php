    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="col text-white">
                <a href="./usuarios/usuarios.php"><img id="imagen" src="./User_icon_2.svg.png" alt="imagen eventos"></a>
            </div>
            <div class="col text-white">
            ...
            <div class="row mt-4">
                ...
                <div class="col text-white">
                    <a href="./personajes/personajes.php"><img id="imagen" src="./champions.png" alt="imagen eventos"></a>
                </div>
            </div>
        </div>
