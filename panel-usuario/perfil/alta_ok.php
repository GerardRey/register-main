...
class Alta_ok
{
	...
	public function insertsql()
	{
		...
		$consulta = mysqli_query($con, "UPDATE usuarios SET pass = '$this->pass', dni = '$this->dni', nombre = '$this->nombre', apellido = '$this->apellido', edad = '$this->edad', mail = '$this->mail', admin = 0 WHERE nick ='$this->nick'");
